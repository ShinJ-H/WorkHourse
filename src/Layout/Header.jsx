                    ...
                    <nav className="navbar navbar-dark navbar-expand py-0">
                        ...
                        >
                            ...
                            <div className="dropdown-menu rounded">
                                <Link to={'/profile'} className="dropdown-item"><i className="fas fa-user-alt me-2"></i> My Profile</Link>
                                <Link to={'/chat'} className="dropdown-item"><i className="fas fa-comment-alt me-2"></i> Inbox</Link>
                                <Link to={'/'} className="dropdown-item"><i className="fas fa-bell me-2"></i> Notifications</Link>
                                <Link to={'/account-settings'} className="dropdown-item"><i className="fas fa-cog me-2"></i> Account Settings</Link>
